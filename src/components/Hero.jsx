    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <a
              href="https://github.com/HarishKamuni"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/harish-kamuni-250032195/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 border rounded-full cursor-pointer border-black/40 dark:border-white/10 hover:scale-105"
            >
            ...
            <a
              href="https://twitter.com/HarishKamuni21"
              loading="lazy"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 border rounded-full cursor-pointer border-black/40 dark:border-white/10 hover:scale-105"
        ...
        >
          ...
          >
            Hello, I'm <span className="text-red-600">HARISH</span>
            <br />
            KAMUNI
          </motion.h1>
          <motion.p
          ...
          <motion.div variants={fadeUp}>
            <a
              href="https://acrobat.adobe.com/id/urn:aaid:sc:ap:8a1abd79-d7eb-4cd4-8e9f-6cabb3ca75dd"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button
